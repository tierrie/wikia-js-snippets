...
var chatOptions = {
  look: {
    ...
    modalIcon: "data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D"
  },
  modules: {
    chatHacks: {
      element: "#chatHacks",
...
if (!$("#chat-options-button").length) {
  $('.Rail').append('<div id="chat-options-button" onclick="openOptions();"><img height="16" width="16" class="sprite gear" src="data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D" /><div class="chat-options">Options</div></div>'); // Prevent multiple buttons from being appended
}
